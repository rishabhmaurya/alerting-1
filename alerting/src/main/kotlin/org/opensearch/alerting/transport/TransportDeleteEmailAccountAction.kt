...
class TransportDeleteEmailAccountAction @Inject constructor(
...
) : ExtensionTransportAction<DeleteEmailAccountRequest, DeleteResponse>(
    DeleteEmailAccountAction.NAME, transportService, actionFilters, ::DeleteEmailAccountRequest, extensionService.isEsCluster
) {
    ...
    override fun doExecuteExtension(task: Task, request: DeleteEmailAccountRequest, actionListener: ActionListener<DeleteResponse>) {
